...
class ProductosQuery:
    ...
    def crear_producto(valores_productos):
        ...
        db.session.commit()
        registro = HistorialCambiosProducto(id_producto=producto.id_producto,nombre=valores_productos["nombre"], descripcion=valores_productos["descripcion"], cantidad=valores_productos["cantidad"], precio=valores_productos["precio"], estado=activo)
